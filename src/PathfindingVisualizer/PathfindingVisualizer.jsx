          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav">
              <li className="nav-item">
                <a
                  className="nav-link"
                  href="https://github.com/veerj11">
                  {' '}
                  PathFinder Visualizer code{' '} (Created by: Virendra Jangir)____________________________________________#FindYourPerfectPath_____________________________________________
                  <img src="pvf.png" alt="PVF" width="50" height="50">
                    </img>
                </a>
              </li>
              <li className="nav-item">
